...
public class TestContext {
     ...
     *
     * @param type  the type of the value (used also as key)
     * @param value the value to add to the TestContext
     * @param <T>   generic type
     * @return the TestContext itself (fluent API)
     */
    public <T> TestContext add(final Class<T> type, final T value) {
        if (type == null) {
     ...
     *
     * @param id    the id to identify the value inside the TestContext
     * @param value the value to add to the TestContext
     * @return the TestContext itself (fluent API)
     */
    public TestContext add(final String id, final Object value) {
        if (value == null) {
     ...
     * for the value.
     *
     * @param type the type of the value to get from the TestContext (used as key)
     * @param <T>  generic type
     ...
     * @param id   the id of the value added to the TestContext
     * @param <T>  generic type
